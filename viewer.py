...
__author__ = "Eugene, Inc"
__copyright__ = "Copyright 2012-2025, Eugene, Inc"
...
def generate_asset_list():
    ...
    playlist = [
        ...
        for asset in enabled_assets if asset.is_active()
    ]
...
def main():
    global scheduler, load_screen_displayed, mq_data
